...
import StoryQuestionsQuickEditForm from './general-questions-quick-edit-form';

// ----------------------------------------------------------------------

export default function GeneralQuestionsTableRow({
  row,
  selected,
  onEditRow,
  onDeleteRow,
  ...
  return (
    <>
      ...
      <StoryQuestionsQuickEditForm
        ...
        onRefreshGeneralQuestions={onRefreshGeneralQuestions}
...
GeneralQuestionsTableRow.propTypes = {
